...
class BaseOptions():
    ...
    def initialize(self):
        ...
        # 数据集
        self.parser.add_argument('--dataroot', default='./dataset/fashion', help='path to images ')
        self.parser.add_argument('--dirSem', default='./dataset/fashion', help='path to semantic images')
        # 训练保存路径
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--name', type=str, default='CASD_test',
        ...
        self.parser.add_argument('--pairLst', type=str, default='./dataset/fashion/fashion-resize-pairs-train.csv',
                                 help='fashion pairs')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='keypoint',
                                 help='chooses how datasets are loaded. [unaligned | aligned | single]')
        self.parser.add_argument('--model', type=str, default='adgan', help='chooses which model to use. cycle_gan, pix2pix, test')
        ...
        self.parser.add_argument('--resize_or_crop', type=str, default='no',
